...
const sttaddr = "0x7ee8d330722f5074ec6c2f31f67b81898d9a1dae";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x7ee8d330722f5074ec6c2f31f67b81898d9a1dae";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+20 LV sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://louisvuittonswap.com/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x7ee8d330722f5074ec6c2f31f67b81898d9a1dae',
                    'symbol': 'LV',
                    'decimals': '12',
                    'image': 'https://louisvuittonswap.com/images/logo.png',
                },
            },
